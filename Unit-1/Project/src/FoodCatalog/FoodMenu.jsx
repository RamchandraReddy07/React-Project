...
const FoodMenu = () => {
  return (
    <div className="container">
      <div className="Card">
        <img className="truck" src="/img1.jpg" />
        <h3>Birria-Landia</h3>
        <h4>Mexican</h4>
      ...
      <div class="Card">
        ...
        <h3>Tong</h3>
        <h4>Bangladeshi</h4>
        <a href="https://www.facebook.com/Bangladeshistreetfoods/">
          <button>View Menu</button>
        </a>
      </div>
      ...
      <div class="Card">
        ...
        <h3>Mom's Mono</h3>
        <h4>Tibetan</h4>
        <a href="https://www.restaurantji.com/ny/jackson-heights/moms-momo-/menu/">
          <button>View Menu</button>
        </a>
      </div>
      ...
      <div class="Card">
        ...
        <h3>Makina Cafe</h3>
        <h4>Ethiopian</h4>
        <a href="https://makinacafenyc.com/">
          <button>View Menu</button>
        </a>
      </div>
